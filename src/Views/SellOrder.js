        ...
        <View style={Style.columnView}>
            <View style={Style.rowView}>
                <View style={Style.block} >
                    <Text style={Style.sellPrice}>{Number(item[0]).toFixed(2)}</Text>

                </View>
                <View style={Style.block} >
                <Text style={Style.sellPrice}>{Number(item[1]).toFixed(5)}</Text>

                </View>
                <View style={Style.block} >
                <Text style={Style.sellPrice}>{Number(item[0] * item[1]).toFixed(5)}</Text>
